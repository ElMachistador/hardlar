...
interface URITokenInterface extends ethers.utils.Interface {
  functions: {
    "COPPER()": FunctionFragment;
    "GOLD()": FunctionFragment;
    "SILVER()": FunctionFragment;
    "SUPERCUTEKITTY()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "SUPERCUTEKITTY",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class URIToken extends BaseContract {
  ...
  functions: {
    ...
    SUPERCUTEKITTY(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    SUPERCUTEKITTY(overrides?: CallOverrides): Promise<PopulatedTransaction>;
